...
public class MasterPayrollListener {
	...
	// This method is for async request / response (Lecture : Inter Process   Communication)
	// Comment either listenMasterPayroll or listenMasterPayrollWithException to  avoid confusion
